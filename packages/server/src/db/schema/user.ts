...
export const user = pgTable("user", {
  ...
  /** Cloud onboarding wizard: false until user finishes or skips. */
  onboardingCompleted: boolean("onboardingCompleted").notNull().default(false),
  /** Last wizard step 1–4 while incomplete; null when completed or not started. */
  onboardingStep: integer("onboardingStep"),
});
